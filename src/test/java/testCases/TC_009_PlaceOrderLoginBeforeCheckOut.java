...
public class TC_009_PlaceOrderLoginBeforeCheckOut extends TestBase{

	@Test
	public void PlaceOrderAfterLogin()
	{
		
		//for this i am gona register first with user Test33 and  then login 
		...
		//from home page click login page 
		...
		lp.loginEmail("test33@33gmail.com");
		lp.loginPassword("test33");
